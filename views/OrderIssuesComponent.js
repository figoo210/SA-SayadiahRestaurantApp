...
const OrderIssuesComponent = ({ index, issues, setIssues, priorities }) => {
    ...
    return (
        <View>
            ...
            {issues[index].active && (
                <>
                    <InputField onValueChange={(value) => updateIssue('orderNumber', value)} placeholder={"Order Number"} value={issues[index].orderNumber} />
                    ...
                    />
                    <TextAreaField onValueChange={(value) => updateIssue('orderDetails', value)} placeholder={"Order Details"} value={issues[index].orderDetails} />
...
export default OrderIssuesComponent;
